/*
	...
	isofs_driver.c: SystemControl IsoFS Driver Code
...
extern int Umd9660ReadSectors2(int lba, int nsectors, void *buf, int *eod);
...
int IsofsReadSectors(int lba, int nsectors, void *buf, int *eod)
{
	...
	return Umd9660ReadSectors2(lba, nsectors, buf, eod);
}
